...
import { adsManagerManagementNavItems, ManagementSectionNav } from '@/components/admin/management-section-nav';
...
export default async function AdsManagerPage({ searchParams }: AdsManagerPageProps) {
  ...
  return (
    <section className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <ManagementSectionNav items={adsManagerManagementNavItems} />
      </div>
